...
Stav: český pracovní návrh v0.2, 11. 9. 2026. Nejde o konečnou publikovanou právní verzi pro zákazníky. Obsahuje viditelné položky k doplnění. Ostatní jazykové verze zásad zatím neexistují.
...
Před vydáním finální verze doplnit otevřené údaje, technicky zkontrolovat souhlasy a teprve potom odstranit označení pracovního návrhu. Publikování HTML nemění nastavení e-shopu. U iframe je navíc potřeba v konečných zásadách zohlednit hosting GitHub Pages a související technické požadavky návštěvníka. Nepřidávat neověřené doby uchování nebo domnělé mezinárodní záruky.
